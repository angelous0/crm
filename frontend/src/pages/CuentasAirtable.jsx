...
export default function CuentasAirtable() {
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-3.5rem)]" data-testid="cuentas-airtable">
      {/* Top Toolbar */}
      ...
      <div className="flex flex-1 min-h-0">
        ...
        <div
          className={`hidden lg:flex flex-col border-r border-slate-200 bg-white shrink-0 transition-all duration-200 ${panelCollapsed ? "w-0 overflow-hidden" : "w-[480px]"}`}
